...
const Footer = () => {
    return (
        <footer className="flex flex-col md:flex-row justify-evenly footer p-10 bg-neutral text-neutral-content">
            <aside>
                ...
                <p>Touristica Pvt. Ltd.<br />Copyright © 2024 - All right reserved</p>
            </aside>
